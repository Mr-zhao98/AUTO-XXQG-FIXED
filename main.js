...
ui.layout(
    <drawer id="drawer">
        <vertical>
            <appbar>
                <toolbar id="toolbar" bg="#ff4fb3ff" title="强国助手Pro"/>
            ...
            <viewpager id="viewpager">
                <frame>
                    <vertical>
                            ...
                            <card w="*" h="70" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" foreground="?selectableItemBackground">
                                <horizontal gravity="center_vertical">
                                    <vertical padding="10 8" h="auto" w="0" layout_weight="1">
                                        <text text="Author：南栀北辰 " textColor="#222222" textSize="16sp" maxLines="1" />
                                        <text text="软件基于Better-Auto-XXQG修改，全部开源" textColor="#999999" textSize="14sp" maxLines="1" />
                                    </vertical>
                                </horizontal>
                            </card>
                            <card w="*" h="70" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" foreground="?selectableItemBackground">
                                <horizontal gravity="center_vertical">
                                    ...
                                    <spinner id="script_chosen" marginLeft="4" marginRight="6" entries="AOTUQG-FIXED" />
                                </horizontal>
                            </card>
                            <card w="*" h="70" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" foreground="?selectableItemBackground">
                                <horizontal gravity="center_vertical">
                        ...
                        <vertical>
                            <button h="50" layout_gravity="center" id="log" textSize="18sp" color="#000000" bg="#00FF00" foreground="?selectableItemBackground" text="查看日志" />
                            <button h="70" id="start" text="开 始 学 习" textSize="25sp" color="#000000" bg="#FF4FB3FF" foreground="?selectableItemBackground"/>
                            <button h="50"  id="join_QQ" text="QQ群" textSize="25sp" color="#000000" bg="#FF1493" foreground="?selectableItemBackground"/>
                        </vertical>
                    </vertical>
                </frame>
                <ScrollView>
...
ui.emitter.on("options_item_selected", (e, item)=>{
    switch(item.getTitle()){
        ...
        case "关于":
            ...
            break;
        case "Github":
            app.openUrl("https://github.com/Mr-zhao98");
            break;
        case "学习强国V2.33.0下载":
...
ui.start.click(function () {
    ...
    threads.start(function () {
        execution = engines.execScriptFile("./xxqg.js");
    });
});
